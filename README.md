...
📚 Me aplico a área de Desenvolvimento de Softaware aplicado a Web em Java usando Sprig Boot criando API RESTs, integração com banco de dados MySQL, H2, PostgreSQL. E para construção de telas usando os princípios UI/UX: JavaScript, CSS e HTML. 
